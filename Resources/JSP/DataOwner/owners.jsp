			...
			<table id="login" align="center">
				...
				<input type="hidden" name="add1" value="YES"></input>
					...
					<tr align="center">
							...
							<td width="75px">:</td>
							<td width="200px">
								<input class="field" type="text" name="username" pattern="^[a-z\d\.]{5,}$" title="five or more characters" required="yes"></input>
							</td>
							...
							<td >:</td>
							<td> 
								<input class="field" type="password" name="password" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$"  title="Password (UpperCase, LowerCase and Number)" required="yes"></input>
							</td>
					</tr>
					...
					<tr align="center">
							...
							<td>:</td>
							<td> 
									<input class="field" type="text" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  title="enter valid mail id" required="yes"></input>
							</td>
							...
							<td>:</td>
							<td> 
								<input class="field" type="text" name="phone" pattern="[0-9]{10}" title="enter 10 digit"></input>
							</td>
					</tr>
			...
			<table id="login" align="center">
			    ...
			    <input type="hidden" name="id" value="<%=id %>"></input>
					...
					<tr align="center">
							...
							<td width="75px">:</td>
							<td width="200px">
								<input class="field" type="text" name="username" value="<%=username %>" pattern="^[a-z\d\.]{5,}$" title="five or more characters" required="yes" readonly="readonly"></input>
							</td>
							...
							<td >:</td>
							<td> 
								<input class="field" type="text" name="password" value="<%=password%>" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" title="Password (UpperCase, LowerCase and Number)" required="yes" readonly="readonly"></input>
							</td>
					</tr>
					...
					<tr align="center">
					       ...
					       <td>Email</td>
							<td>:</td>
							<td> 
									<input class="field" type="text" name="email" value="<%=email%>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="enter valid mail id" required="yes"></input>
							</td>
							...
							<td>:</td>
							<td> 
								<input class="field" type="text" name="phone" value="<%=phone%>" pattern="[0-9]{10}" title="enter 10 digit"></input>
							</td>
					</tr>
