			...
			<table id="login" align="center">
				...
				<input type="hidden" name="add1" value="YES"></input>
					...
					<tr align="center">
							...
							<td>:</td>
							<td> 
									<input class="field" type="text" name="phone" pattern="[0-9]{10}" title="enter 10 digit" required="yes"></input>
							</td>
							...
							<td>:</td>
							<td> 
								<input class="field" type="text" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="enter valid mail id" ></input>
							</td>
					</tr>
			...
			<table id="login" align="center">
			    ...
			    <input type="hidden" name="id" value="<%=id %>"></input>
					...
					<tr align="center">
							...
							<td >:</td>
							<td> 
								<input class="field" type="text" name="password" value="<%=password%>" required="yes" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" readonly="readonly"></input>
							</td>
					</tr>
					...
					<tr align="center">
							...
							<td>:</td>
							<td> 
									<input class="field" type="text" name="name" value="<%=username %>" pattern="^[a-z\d\.]{5,}$" required="yes"></input>
							</td>
					...
					<tr align="center">
					       ...
					       <td>Email</td>
							<td>:</td>
							<td> 
									<input class="field" type="text" name="email" value="<%=email%>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="yes"></input>
							</td>
							...
							<td>:</td>
							<td> 
								<input class="field" type="text" name="phone" value="<%=phone%>" pattern="[0-9]{10}"></input>
							</td>
					</tr>
