...
<title>EHR BlockChain Projecta</title>
<!--
Stimulus Template
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/bootstrap2.min.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/bootstrap3.min.css">
...
Access Control Technique
		...
		<br><br><br><br><br>
          ...
          <a href="index.jsp"><b>Click Here to go back</b></a>
          </center>
<!-- SCRIPTS -->
