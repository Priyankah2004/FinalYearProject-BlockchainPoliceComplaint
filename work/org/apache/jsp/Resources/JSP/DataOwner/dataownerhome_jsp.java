...
public final class dataownerhome_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/OwnerProfile\" target=\"myIframe\">View Profile</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath() );
      out.write("/EditOwnerProfile?no=1\" target=\"myIframe\">Edit Profile</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath() );
      ...
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/ListUser?submit=get\" target=\"myIframe\">View User Details</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/ListUser?submit=Add\" target=\"myIframe\">Add User Details</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/ListUser?submit=Edit\" target=\"myIframe\">Update User Details</a></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</li> -->\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<li>\r\n");
      ...
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/Resources/JSP/Admin/upload_file.jsp\" target=\"myIframe\">Upload File</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/UploadFileList?submit=get\" target=\"myIframe\">View Details</a></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</li>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<li>\r\n");
      out.write("\t\t\t<a href=\"#\">File Access Control</a>\r\n");
      out.write("\t\t\t<ul>\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/Resources/JSP/Admin/access_control.jsp\" target=\"myIframe\">Control File Access</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/AccessFileControlList?submit=get\" target=\"myIframe\">View Access Control </a></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</li>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<li>\r\n");
      ...
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/UploadFileList?submit=get\" target=\"myIframe\">View Transactions</a></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</li>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<li>\r\n");
      ...
      out.write("\t\t\t\t<li><a href=\"");
      out.print(request.getContextPath());
      out.write("/index.jsp?no=5\">Sign Out</a></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\t\t</li>\r\n");
      out.write("\t\t\r\n");
      out.write("\t</ul>\r\n");
      ...
      out.write("\t\t<iframe align=\"middle\" frameborder=\"0\" scrolling=\"auto\" name=\"myIframe\" height=\"800\" width=\"1150\"></iframe>\r\n");
      out.write("</div>\t\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
