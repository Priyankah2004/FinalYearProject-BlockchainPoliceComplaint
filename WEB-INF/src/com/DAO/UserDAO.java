...
public class UserDAO 
{
	...
	public boolean checkUser(String username,String password)
	{
		...
		try
		{
			...
			{
				System.out.println("Userrrrrrrrrrrr:"+resultSet.getString(2));
				flag=true;
			}
	...
	public int getID(String username)
	{
		...
		try
		{
			...
			System.out.println("User ID is gid : "+i);
		}
		catch(Exception e)
		{
	...
	public int getDepartmentID(String username)
	{
		...
		try
		{
			...
			connection=dao.connector();
			statement = connection.createStatement();
			resultSet = statement.executeQuery("select dept_code1 from m_user where username='"+username+"'");
			while(resultSet.next())
			{
				i=resultSet.getInt(1);
			}
	...
	public int getDesignationID(String username)
	{
		...
		try
		{
			...
			connection=dao.connector();
			statement = connection.createStatement();
			resultSet = statement.executeQuery("select design_code1 from m_user where username='"+username+"'");
			while(resultSet.next())
			{
				i=resultSet.getInt(1);
			}
