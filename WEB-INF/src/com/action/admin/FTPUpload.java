	...
	public void service(HttpServletRequest req,HttpServletResponse res)throws IOException
	{
	       ...
	       { 
				...
				try
				{
					...
					String email = adminDAO.getEmail(username);
				        ...
				        String value=""+previousblkvale+"~"+date+"~"+""+randomNumber+"~"+hashtag;
					     ...
					     //   File newFile = new File("D:\\EHR_Blocks\\"+zipblkame);
					       ...
					       // FileOutputStream fos = new FileOutputStream("D:\\EHR_Blocks\\"+zipblkame);
					        ...
					        String ftpusername = "priyankah669";
					        String ftppassword = "Priya#####2004";
					...
					flag = adminDAO.addUploadTransaction(fileid,filename,fileType,date,uploadSubject,cloudId,ownerId,previousblkvale,hashtag,zipblkame,randomNumber,priority);
					
					
					flag = true;
					
					
					String subject = "Police Complaint ";
					String message="<html> <br> <b> <h3>Hello!<br>Your Complaint is sucessfully registered</h3> </b> </html>";
                 ...
                 Boolean  flag1 = CL_SendMail.sendPersonalizedMail(email, fromEmailId,password,subject,message,attachedFilePath,hostname,portnumber);
					...
					if(flag)
					{
						...
						rd=req.getRequestDispatcher("/Resources/JSP/Admin/select_file.jsp?no=1&file_name="+filename+"&cloud="+sb.toString()+"&priority="+priority+"");
						rd.forward(req,res);
					}
					else
					{
