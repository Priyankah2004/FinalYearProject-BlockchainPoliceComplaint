...
//		    keyInfo = ReadLastLineOfFile.readLastLineOfAFile(destFilePath);
		    ...
		    keyInfo = userDAO.getID(username);;
...
//		    	designCode1 = Integer.parseInt(info[2]);
//		    	//designCode2 = Integer.parseInt(info[4]);
//		    }
		    deptCode1 = userDAO.getDepartmentID(username);
		    designCode1 = userDAO.getDesignationID(username);
		    
		    System.out.println("******* Veryfication Info **************");
		    System.out.println("       User Id : " + keyInfo);
